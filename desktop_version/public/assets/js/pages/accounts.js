...
//Preloading on start   
var obj1, obj2, obj, s1, tablesource, user, currentUid, privilages, email, user2;
...
db.collection("Settings").doc("Accounts")
   .onSnapshot(function (doc) {
      ...
      db.collection("Accounts/mdb/main").orderBy("date", "desc").where("user", "==", user).limit(4)
...
$(document).ready(function () {
   ...
   $("#transnature").change(function () {
      ...
      if (v1 == "Outflow") {
         ...
         var newOptions2 = ["Expense", "Procurement", "Bank Deposit"];
   ...
   $("#myform1").submit(function (e) {
      ...
      if (tn == "Inflow") {
         ...
         if (typ == "Bank Withdrawal") {
            ...
            datainsert("Accounts/mdb/main/" + todaysdate(2), details);
