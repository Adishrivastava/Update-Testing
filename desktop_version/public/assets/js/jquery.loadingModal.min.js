!(function (s, i, c, t) {
				...
				rotatingPlane: {
					...
					setBackground: function (i) {
						e.animationBox.find('*').each(function (c, t) {
							s(t).css('background-color') &&
								'rgba(0, 0, 0, 0)' != s(t).css('background-color') &&
								s(t).css('background-color', i);
						});
					},
				},
				wave: {
	...
	s.extend(e.prototype, {
		init: function () {
			...
			'' !== this.settings.text ? d.html(this.settings.text) : d.hide(),
				(this.currenAnimation = this.animations[this.settings.animation]),
				t.append(this.currenAnimation.html),
				e.append(t).append(d),
				i.append(c),
				i.append(e),
				'auto' === this.settings.position &&
				'body' !== this.element.tagName.toLowerCase()
					? (i.css('position', 'absolute'),
					  s(this.element).css('position', 'relative'))
					: 'auto' !== this.settings.position &&
					  s(this.element).css('position', this.settings.position),
				s(this.element).append(i),
				(this.modalBg = c),
				(this.modal = i),
				(this.modalText = d),
				(this.animationBox = t),
		...
		color: function (c) {
			s('[data-custom-style]').remove(),
				this.modalText.css('color', c),
				this.currenAnimation.setBackground
					...
					: this.animationBox
							...
							.each(function (t, e) {
								s(e).css('background-color') &&
									'rgba(0, 0, 0, 0)' != s(e).css('background-color') &&
									s(e).css('background-color', c),
									'rgba(0, 0, 0, 0)' !==
										i
											.getComputedStyle(e, ':before')
											.getPropertyValue('background-color') &&
		...
		animation: function (s) {
			this.animationBox.html(''),
				(this.currenAnimation = this.animations[s]),
		...
		(s.fn[d] = function (i) {
			...
			if (i === t || 'object' == typeof i)
				return this.each(function () {
					s.data(this, 'plugin_' + d) ||
						s.data(this, 'plugin_' + d, new e(this, i));
				});
			if ('string' == typeof i && '_' !== i[0] && 'init' !== i) {
				...
				return (
					this.each(function () {
						...
						t instanceof e &&
							'function' == typeof t[i] &&
							(l = t[i].apply(t, Array.prototype.slice.call(c, 1))),
							'destroy' === i && s.data(this, 'plugin_' + d, null);
					}),
					l !== t ? l : this
				);
			}
